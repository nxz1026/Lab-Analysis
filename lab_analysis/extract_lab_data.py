...
_METRIC_ALIAS = {
    ...
    "血小板计数": "PLT", "PLT": "PLT",
    "血小板比容": "PCT", "PCT": "PCT",
    "大型血小板比率": "P-LCR", "P-LCR": "P-LCR",
    "平均红细胞体积": "MCV", "MCV": "MCV",
    "平均红细胞血红蛋白含量": "MCH", "MCH": "MCH",
    "平均红细胞血红蛋白浓度": "MCHC", "MCHC": "MCHC",
    "中性粒细胞百分率": "NEUT%", "NEUT%": "NEUT%",
    "淋巴细胞百分率": "LYMPH%", "LYMPH%": "LYMPH%",
    "单核细胞百分率": "MONO%", "MONO%": "MONO%",
    "嗜酸性粒细胞百分率": "EO%", "EO%": "EO%",
    "嗜碱性粒细胞百分率": "BASO%", "BASO%": "BASO%",
    "中性粒细胞绝对数": "NEUT#", "NEUT#": "NEUT#",
    "淋巴细胞绝对数": "LYMPH#", "LYMPH#": "LYMPH#",
    "单核细胞绝对数": "MONO#", "MONO#": "MONO#",
    "嗜酸性粒细胞绝对数": "EO#", "EO#": "EO#",
    "嗜碱性粒细胞绝对数": "BASO#", "BASO#": "BASO#",
    "红细胞体积分布宽度.*?SD": "RDW-SD", "RDW-SD": "RDW-SD",
    "红细胞变异系数.*?CV": "RDW-CV", "RDW-CV": "RDW-CV",
    "平均血小板体积": "MPV", "MPV": "MPV",
    "血小板体积分布宽度": "PDW", "PDW": "PDW",
    "C反应蛋白测定": "CRP", "CRP": "CRP",
    "超敏C反应蛋白": "hs-CRP", "hs-CRP": "hs-CRP",
}
...
def _parse_ocr_to_json(ocr_text: str) -> dict:
    ...
    result["report_date"] = (f"{date_m.group(1)}-{date_m.group(2).zfill(2)}-{date_m.group(3).zfill(2)}"
                             if date_m else "")
